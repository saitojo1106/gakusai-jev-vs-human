...
学祭のように人が並ぶ場では、次の 2 つのどちらかが要る。

- [AI Gateway Credits を購入して有料枠に移る](https://vercel.com/docs/ai-gateway/pricing)。Gateway 側の制限が消え、残るのは上流プロバイダの制限だけになる
- 同時に遊べるのを 1 台に限り、シフト開始の間隔を 30 秒以上あける
